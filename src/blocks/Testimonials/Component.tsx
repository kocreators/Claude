        ...
        <div className="divide-y divide-canvas-light/10">
          {items.map((t: any) => (
            <blockquote key={t.id} className="grid gap-8 py-16 first:pt-0 last:pb-0 md:grid-cols-[1fr_auto] md:items-end">
              <p className="max-w-3xl text-3xl font-extrabold uppercase leading-[1.1] tracking-tight md:text-5xl">
                &ldquo;{t.quote}&rdquo;
              </p>
              <footer className="label flex items-center gap-3 text-canvas-light/60 md:flex-col md:items-end md:text-right">
